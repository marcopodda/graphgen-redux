...
class Model(nn.Module):
    def __init__(self, hparams, mapper):
        ...
        # Graph configuration
        self.v_max = mapper['max_nodes']
        self.num_prop_rounds = hparams.hops
        self.node_hidden_size = hparams.feat_size
    ...
    def forward(self, batch_size, actions, training=True):
        if training:
...
class DGMGTrainer(Trainer):
    ...
    def get_wrapper(self):
        return DGMG(self.hparams, self.dataset.mapper)